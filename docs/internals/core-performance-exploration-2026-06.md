...
```sh
cargo bench -p query-farm-iroh-http-core --bench channel channel -- --warm-up-time 1 --measurement-time 3
```
...
```sh
cargo bench -p query-farm-iroh-http-core --bench throughput fetch_get_latency -- --warm-up-time 1 --measurement-time 3
cargo bench -p query-farm-iroh-http-core --bench throughput multiplex -- --warm-up-time 1 --measurement-time 3
```
...
```sh
cargo bench -p query-farm-iroh-http-core --bench channel body_reader_http_body -- --warm-up-time 1 --measurement-time 3
```
